...
def get_added(text,chat,bot):    
    try:
        ...
        send_text = 'سلام  دوست عزیز ' + group + ' خوش آمدی ❤ \n لطفا قوانین رو رعایت کن ✅'
        bot.sendMessage(chat['object_guid'],  send_text, chat['last_message']['message_id'])
    except:
        print('rub server err')
                    ...
                    if 'SendMessages' in access and chat['last_message']['type'] == 'Text' and text.strip() != '':
                        ...
                        if not m_id in list_message_seened:
                            ...
                            if text == 'تست':
                                ...
                                try:
                                    bot.sendMessage(chat['object_guid'], 'با سلام با ربات هوشمند ارتقاء یافت 🤖 بی تی  از 3 خوش اومدی برای پنل کلمه(دستورات) بگید!',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'سلام':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سلامــ 🖤😉',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                        
                            ...
                            if text == 'جون':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'کونــــ مدی یا لبــ 😂 {user}',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'هعب':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'هعی زندگی',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')   
                            if text == 'آفرین':
                            ...
                            if text == 'ویروس':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سازندمه به ایدیه @Alir_rza_2022',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'تیز':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'مـــگه عمتــم مگی تیز😒😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'سم بگو':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سام بادی گیو می هایااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااااهههههههههههههههههههههه😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'نت ندارم':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'هعی داداش منو از کونـــ دادن پول نت پیدا میکنــم😂😿',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'اسمت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'من زهرامــ ت اصل بده',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'اصل':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'بات24 ساعت هوشمند از ویروس😍😌',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'ربات':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'جونــــم دستور بفرمام😁😍',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'پشمام':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'گورخیدم😰😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'رل پی':
                            ...
                            if text == 'نمدو':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'وایی چیرو😳😟',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'صلم':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'حقیــــر مثل ادم سلام کن😡😒',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'چرا':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'من عشقم همه رل های قبلیمــ کشتم😲😢',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == '😈':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'هکرمان امد😱😢',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == '😡':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'ببخشید دیگ تکرار نمیشه😖',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'حق':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'ســتــاده مــبــارزه بــا حــق گــویــان😉😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'عشقم':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'جونــــــ',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'میگامت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'گوه خوردم',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1') 
                                                                                                                    
                            if text == 'دختری یا پسر':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'دخترمـ میخواهی رل بزنیـ👩😁',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')    
                            ...
                            if text == 'تیتاپ':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'جایزه شما یکـــ عدد تیتاپــ🥢',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'ممه میقام':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'بیا میمه ۸۵ بقول🙂🍼',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'بازی کنیم':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'کدوم بازی بریم',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                         
                            if text == 'جرعت یا حقیقت؟':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'حقیقت',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'جق زدی':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'حـــقـــیــر  این چ سمیه‌ معلوم جق زدم😛😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                          
                            if text == 'شاخم':
                            ...
                            if text == 'جرعت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'عمــــت میقولی😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                                        
                            if text == 'شب خوش':
                            ...
                            if text == 'مشت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'یه مشت رو صورتـت بزنم😁😄',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                                               
                            if text == 'هان':
                            ...
                            if text == 'ناموسن':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'عا بملـا😕😄',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                                                        
                            if text == 'اوانجر':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سازندمه دومم @Mr_avanger_lran1',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')         
                            ...
                            if text == 'مستم':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'با اب مح یا شراب مست کردی',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                                                   
                            if text == 'چخبر':
                            ...
                            if text == 'کسی نیس':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'نــه هــمــه حــولــا دارن تــو پــیــوی هــم دیــگــه سک.س چــت مــیــکـــنــن😹💔',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'صگ':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'یعنی روبیک صــگ داره',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'کسی نیس؟':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'نــه هــمــه حــولــا دارن تــو پــیــوی هــم دــیــگه سک.س چــت مــیــکــنــن😹💔',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'بات':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'جـــــانـــــه ویروســــ باتم😷💥',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'اموزش':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'اموزش این ربات فقط با 500 سین',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'گپ':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'https://rubika.ir/joing/BGEBHCHA0UMSIXIQILHWFURFEKVZYHPR',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'لینک کانال':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'https://rubika.ir/joinc/BEFIHCEJ0GZQRQZDNGHZOONWFLWGWBNN',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'شاه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'شاه فشاری شده سوار گاری شده😃😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                 
                            if text == 'به تو چه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'زر نزن حجی',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'پول میخوام':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'منم فقیرم پیل مخوام😎😿',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'سازندت کیه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'اوانجر و ویروسـ',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'بات اوسکول':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'هـــوشـــع اروم مـــن خودتو نــیـــســم هـــا هــی اوســــکــــول صـــدام مـــیـــزنــــی🙄💔',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'شاخ نشو':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'شاخ نمیشم چون من رباتم😂',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'ممه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'یکی درم فقط😨😒',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')         
                            ...
                            if text == 'انیمه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'منم انیمه دوستـــ درم😻😽',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                                                   
                            if text == 'کسی بلده جوک بگه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'منــــ بلدم',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                 
                            if text == 'فدات':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'روم سیاه',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'گودرت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'ار دا تو و اوانجر قدرت دارید',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'دمت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'خواهش میکنم وظیفمه',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'فیـل':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'وایی فیلــ.لتر شدم😨😱',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'گوشیت چیست':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'ایفون',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'سیک ':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'پــــش عـــمــ ســـ.یـک کــــنـــــم🤤💋',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')         
                            if text == 'باشه':
                            ...
                            if text == 'هعی داداش':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'بیا پی',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'اصل بده':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'زهرام',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'نمیخوام':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'],'ب عنم',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'هلو':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'جونم عشقم میخای بهت بدم؟👄',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'زیر ابیا':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'دارن زیـــــر اب سکـ.س انــــجـــــام مــــیــــدن کـــــــارشــــــون نـــــداشـــــتــــه بـــــاش🤣💔',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'اها':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'خوبــــ فهمیدیـــ دادا',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')                                                                                                 
                            if text == 'اوک':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'حلــه داداش😾🔥',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
